...
\begin{trchimiche}
	Trasformazioni che avvengono ALTERANDO la natura delle sostanze coinvolte e portando alla formazione di nuovi composti.
\end{trchimiche}
...
\end{equation*}
Al termine della trasformazione abbiamo una sostanza differente da quella di partenza, in alcuni casi la procedura non è reversibile, come in questo caso.
\section{Sostanza pure}
\newtheorem{sopure}{Definizione}
\begin{sopure}
	MATERIA DI COMPOSIZIONE OMOGENEA CHE NON PUÒ ESSERE SEPARATA
IN ALTRI TIPI DI MATERIA PER MEZZO DI TRASFORMAZIONI FISICHE
\end{sopure}
\begin{figure}[h]
	\centering
