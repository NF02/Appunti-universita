...
\begin{tasks}(1)
	\task Sia f limitata e integrabile secondo Riemann in [a,b] Allora
	\fbox{
...
L’ipotesi di continuità per f è fondamentale per la derivabilità di F. Infatti, se f è solo integrabile \underline{non} si può affermare che F è derivabile.
