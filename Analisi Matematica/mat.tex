...
\input{pag/Studio di funzione p2.tex}
\input{pag/Studio di funzione p3.tex}
\input{pag/successioni nuneriche.tex}
\input{pag/esercizi.tex}
\input{pag/introduziona_Analisi2.tex}
\printindex
\end{document}
