...
\subsection{Definizione di limite sinistro}
...
\subsection{Teorema d'unicità del limite}
Se $\lim_{x\to x_0} f(x)=l\Rightarrow l è unico$\\
...
\end{tabular} allora la retta verticale \begin{tabular}{|l|}
	\hline
	$x=x_0$\\\hline
\end{tabular}v si chiama asintoto verticale
