...
\begin{description}
	...
	\item[$+\infty-\infty$ ] Il limite che andremo a studiare è
		...
		\begin{equation*}
			\lim_{x\to\infty}\frac{(\sqrt{x^2+x}-\sqrt{x^2-x})(\sqrt{x^2+x}+\sqrt{x^2-x})}{\sqrt{x^2+x}+\sqrt{x^2-x}}=\lim_{x\to\infty}\bigg[\frac{(x^2+x)-(x^2)}{\sqrt{x^2+x}+\sqrt{x^2-x}} \bigg]=\lim_{x\to\infty}\frac{2x}{\sqrt{x^2+x}+\sqrt{x^2-x}}
		\end{equation*}
		\begin{equation*}
			=\frac{\infty}{\infty}
		\end{equation*}
