...
Si Lascia cadere un sasso in un pozzo. il tempo nell'acqua viene percepito con
un ritardo di 2.40s, a quale distanza dall'imboccatura del pozzo si trova la superficie dell'acqua? La velocità del suono nell'aria è 336 m/s.
\begin{center}
	\begin{tikzpicture}[domain=-2:7] 
...
\begin{center}
	By \href{https://it.wikipedia.org/wiki/Modello_atomico_di_Bohr}{Whikipedia}
\end{center}
