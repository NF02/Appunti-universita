...
\begin{defi}
  ...
  \begin{multicols}{2}
    ...
    \begin{equation}
      \label{eq:velang}
      \omega=\sfrac{2\pi_{rad}}{T}=2\pi\cdot f
    \end{equation}
    \begin{equation}
      \label{eq:Velang}
...
\subsubsection{Sostituzioni e formule inverse}
\label{sec:sostform}

\begin{eqnarray}
  \label{eq:sostform}
  a_c=\omega^2r; & v=\frac{2\pi \cdot r}{T};
  & \omega=\frac{v}{r}\\
  r=\frac{V\cdot T}{2\cdot\pi}; & r=\frac{V}{\omega};
  & r=\frac{v^2}{a_c}\\
  r=\frac{a_c}{\omega^2}; & T=\frac{2\pi r}{v};
  & T=\frac{2\pi}{\omega}\\
\end{eqnarray}
...
\subsubsection{Accelerazione el centro di massa (di un sistema di particelle)}
...
\section{Equazione del moto di un oscillazione armonico (moto armonico)}
