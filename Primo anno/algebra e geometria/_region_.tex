\message{ !name(algebra-e-geometria.tex)}\documentclass{book}
...
\message{ !name(algebra-e-geometria.tex) !offset(179) }

\begin{oss}
  Bisognerebbe porsi il problema dell'
\message{ !name(algebra-e-geometria.tex) !offset(178) }
